...
class AppColors {
  ...
  static const Color customMobileSearchBarBorder = Color(0xFFD8DCE4);

  // Background color
  static const Color backgroundMobileAppbar = Color(0xFFF7FAFE);
  ...
  static const Color buttonBackgroundGreen = Color(0xFF09A17A);
  ...
  static const Color backgroundColorCircle = Color(0xFFF5F5F5);
