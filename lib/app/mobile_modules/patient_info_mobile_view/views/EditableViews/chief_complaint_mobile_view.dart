...
class ChiefComplaintMobileView extends StatelessWidget {
  PatientInfoMobileViewController controller;

  ChiefComplaintMobileView({super.key, required this.controller});
        ...
        itemBuilder: (context, index) {
          return HtmlEditorViewWidget(
            ...
            onUpdateCallBack: (impressionModel, content) {
              ...
              controller.editableChiefView.refresh();
              controller.updateFullNote("chief_complain", controller.editableChiefView);
