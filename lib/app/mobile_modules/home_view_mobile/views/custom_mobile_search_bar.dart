...
class CustomMobileSearchBar extends StatefulWidget {
  ...
  CustomMobileSearchBar({super.key, this.onChanged, this.onSubmit, this.hintText = 'Search', this.controller, this.borderRadius, this.border, this.fillColor, this.padding, this.hintStyle, this.iconSize = 20.0, this.iconColor, this.showClearButton = false});

  @override
  _CustomMobileSearchBarState createState() => _CustomMobileSearchBarState();
}

class _CustomMobileSearchBarState extends State<CustomMobileSearchBar> {
  ...
  @override
  void didUpdateWidget(CustomMobileSearchBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultBorder = widget.border ?? Border.all(color: AppColors.customMobileSearchBarBorder, width: 1.0);
    final fillColor = widget.fillColor ?? theme.cardColor;
    final iconColor = widget.iconColor ?? theme.iconTheme.color;
    final hintStyle = widget.hintStyle ?? theme.textTheme.bodyMedium?.copyWith(color: AppColors.textDarkGrey);
