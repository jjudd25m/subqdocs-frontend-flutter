              ...
              Expanded(
                child: HtmlEditor(
                  ...
                  htmlToolbarOptions: HtmlToolbarOptions(
                    ...
                    dropdownIcon: Padding(padding: EdgeInsets.only(right: 10, top: 10, bottom: 10), child: SvgPicture.asset(ImagePath.search, height: 10, width: 10)),
                    ...
                    customToolbarButtons: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(40), border: Border.all(width: 2, color: Colors.red)),
                          child: SvgPicture.asset(ImagePath.image_attchment),
                        ),
                      ),
                    ],
                ...
                htmlToolbarOptions: HtmlToolbarOptions(
                  ...
                  customToolbarButtons: [
                    InkWell(
                      ...
                      child: Container(padding: EdgeInsets.all(20), decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), border: Border.all(width: 2, color: Colors.red)), child: SvgPicture.asset(ImagePath.search)),
                    ),
                  ],
