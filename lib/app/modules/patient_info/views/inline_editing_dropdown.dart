...
class InlineEditingDropdown extends StatefulWidget {
  ...
  InlineEditingDropdown({required this.initialText, this.width = 300, required this.onSubmitted, required this.onChanged, required this.focusNode, this.toggle, this.textStyle, Key? key})
    : super(key: key);
