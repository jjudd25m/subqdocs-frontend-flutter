        ...
        children: [
          if ((controller.isFullNoteLoading.value ||
            ...
            if (controller.patientFullNoteModel.value?.responseData?.status == "Failure") ...[
              Center(
                  child: Text(
                controller.patientFullNoteModel.value?.responseData?.message ?? "No data found",
                                                                      ...
                                                                      TextSpan(
                                                                        children: [
                                                                          if (controller.patientFullNoteModel.value?.responseData?.fullNoteDetails?.reviewOfSystem!.toJson().values.toList()[index] !=
                                                                            ...
                                                                            TextSpan(
                                                                              text: controller.patientFullNoteModel.value?.responseData?.fullNoteDetails?.reviewOfSystem!
                                                                                      .toJson()
                                                                                      .values
                                                                                      .toList()[index] ??
                                                                                  "-",
