                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Expanded(
                                                        child: Text(
                                                      textAlign: TextAlign.left,
                                                      "Scar on right side of the nose (L90.5)",
                                                      style: AppFonts.regular(15, AppColors.textGrey),
                                                    )),
                                                  ],
                                                ),
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  textAlign: TextAlign.left,
                                  "Don, an established patient, returned today for a full-body skin exam due to his recent history of malignant melanoma in situ on his nose. He reports no signs of recurrence. Don also wanted to explore treatment options to improve the appearance of the scar on his nose.",
