...
class CheckNewUserModel {
  bool? responseData;
  String? message;
  bool? toast;
  String? responseType;

  CheckNewUserModel({this.responseData, this.message, this.toast, this.responseType});

  CheckNewUserModel.fromJson(Map<String, dynamic> json) {
