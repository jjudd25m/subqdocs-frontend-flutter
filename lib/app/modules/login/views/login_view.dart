                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Obx(() {
                          return Checkbox(visualDensity: VisualDensity.compact, materialTapTargetSize: MaterialTapTargetSize.shrinkWrap, activeColor: AppColors.backgroundPurple, value: controller.isRememberMe.value, onChanged: (value) => {controller.isRememberMe.value = value!});
                        }),
