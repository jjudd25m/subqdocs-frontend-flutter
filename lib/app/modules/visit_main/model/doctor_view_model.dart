...
class DoctorViewResponseData {
  ...
  DoctorViewResponseData.fromJson(Map<String, dynamic> json) {
    ...
    status = json['status'];
    visitDate = json['visit_date'];
    mainDiagnosisCodesProcedures = json['diagnosis_codes_procedures'] != null ? MainDiagnosisCodesProcedures.fromJson(json['diagnosis_codes_procedures']) : null;
    if (json['impressions_and_plan'] != null) {
      impressionsAndPlan = <ImpressionsAndPlan>[];
      json['impressions_and_plan'].forEach((v) {
        impressionsAndPlan!.add(ImpressionsAndPlan.fromJson(v));
  ...
  ImpressionsAndPlan.fromJson(Map<String, dynamic> json) {
    ...
    if (json['sibling_icd_10'] != null) {
      ...
      json['sibling_icd_10'].forEach((v) {
        siblingIcd10!.add(SiblingIcd10.fromJson(v));
      });
    }
...
class ImpressionsAndPlanProcedure {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['type'] = type;
    data['details'] = details;
    data['type_with_location'] = typeWithLocation;
...
class MainDiagnosisCodesProcedures {
  ...
  MainDiagnosisCodesProcedures.fromJson(Map<String, dynamic> json) {
    if (json['diagnosis_codes_procedures'] != null) {
      ...
      json['diagnosis_codes_procedures'].forEach((v) {
        diagnosisCodesProcedures!.add(MainDiagnosisCodesProceduresDiagnosisCodesProcedures.fromJson(v));
      });
    }
    if (json['possible_diagnosis_codes_procedures'] != null) {
      ...
      json['possible_diagnosis_codes_procedures'].forEach((v) {
        possibleDiagnosisCodesProcedures!.add(PossibleDiagnosisCodesProcedures.fromJson(v));
      });
    }
  }
...
class Procedure {
  ...
  Procedure({this.code, this.description, this.shortDescription, this.modifier, this.confidenceScore, this.procedurePossibleAlternatives});
  ...
  Procedure.fromJson(Map<String, dynamic> json) {
    ...
    if (json['possible_alternatives'] != null) {
      ...
      json['possible_alternatives'].forEach((v) {
        procedurePossibleAlternatives!.add(ProcedurePossibleAlternatives.fromJson(v));
      });
    }
  }
...
class ProcedurePossibleAlternatives {
  ...
  ProcedurePossibleAlternatives({this.code, this.description, this.shortDescription, this.modifier, required this.isPin});
...
class Diagnosis {
  ...
  Diagnosis.fromJson(Map<String, dynamic> json) {
    ...
    if (json['possible_alternatives'] != null) {
      ...
      json['possible_alternatives'].forEach((v) {
        diagnosisPossibleAlternatives!.add(DiagnosisPossibleAlternatives.fromJson(v));
      });
    }
  }
