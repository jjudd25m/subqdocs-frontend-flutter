...
class TableCustom extends StatelessWidget {
  ...
  TableCustom({required this.rows, this.onLoadMore, required this.cellBuilder, required this.columnCount, required this.context, required this.columnWidths, this.onRowSelected, this.physics});
