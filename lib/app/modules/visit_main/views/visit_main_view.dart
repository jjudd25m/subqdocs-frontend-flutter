...
class _VisitMainViewState extends State<VisitMainView> {
  VisitMainController controller = Get.find<VisitMainController>(
                        ...
                        children: [
                          ...
                          Theme(
                            ...
                            child: ExpansionTile(
                              ...
                              children: <Widget>[
                                VisitSnapShotEditbale(controller: controller),
                                SizedBox(height: 10),
                              ],
                            ),
                          ),
                          ...
                          Theme(
                            ...
                            child: ExpansionTile(
                              ...
                              children: <Widget>[
                                PersnoalNoteEditable(controller: controller),
                                SizedBox(height: 10),
                              ],
                            ),
                          ),
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: CommonContainer(
                                    ...
                                    child: MedicationHistoryEditable(
                                      controller: controller,
                                    ),
                                  ),
                                ),
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      if (controller.isConnected.value) {
                                        controller.globalController.addRoute(
                                    ...
                                    onTap: () {
                                      ...
                                      aweSideSheet(
                                        ...
                                        body: VisitMainAttachmentFilter(
                                          onTap: () {
                                            print(
                                              "on tap VisitMainAttachmentFilter",
                                            );
                                            // controller.getPatientAttachment();
                                        ...
                                        print(
                                          "on then VisitMainAttachmentFilter",
                                        );
                                        // controller.getPatientAttachment();
                                        // controller.getPastVisitList(isFist: true);
                                        print("value");
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      ...
                                                                      child: GestureDetector(
                                                                        onTap: () {
                                                                          customPrint(
                                                                            controller.patientAttachmentList[index].fileType?.contains(
                                                                              "image",
                                                                            ),
                                                                          );

                                                                          if (controller.patientAttachmentList[index].fileType?.contains(
                                                                                "image",
                                                                              ) ??
                                                                              false) {
                                                                            showDialog(
                                                                              ...
                                                                              builder: (
                                                                                ...
                                                                                return ViewAttchmentImage(
                                                                                  imageUrl:
                                                                                      controller.patientAttachmentList[index].filePath ??
                                                                                      "",
                                                                                  attchmentUrl:
                                                                                      '',
                                                                                );
                                                                                ...
                                                                                return DeleteImageDialog(
                                                                                  onDelete: () {
                                                                                    controller.deleteAttachments(
                                                                                      controller.patientAttachmentList[index].id ??
                                                                                          0,
                                                                                    );
                                                                                  },
                                                                                  extension:
                                                                                      controller.patientAttachmentList[index].fileType,
                                                                                );
                                                                              },
                                                                            );
                                                                          },
