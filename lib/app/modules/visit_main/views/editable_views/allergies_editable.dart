...
class AllergiesEditable extends StatelessWidget {
  VisitMainController controller;
  AllergiesEditable({super.key, required this.controller});
  ...
  Widget _taskListSection() {
    return Obx(() {
      return ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: controller.editableAllergies.length,
        itemBuilder: (context, index) {
          return HtmlEditorViewWidget(
            heightOfTheEditableView: 250,
            impresionAndPlanViewModel: controller.editableAllergies[index],
            onUpdateCallBack: (impressionModel, content) {
              controller.editableAllergies[index] = impressionModel;
              controller.editableAllergies.refresh();
              controller.updateFullNote("allergies", controller.editableAllergies);
            },
