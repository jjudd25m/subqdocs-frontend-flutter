...
class DeleteScheduleVisit extends StatelessWidget {
  ...
  DeleteScheduleVisit({super.key, required this.onDelete, this.extension});
          ...
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text("Cancel Visit", style: AppFonts.medium(15, Colors.white)),
                    const Spacer(),
                    GestureDetector(
                      onTap: () {
                        Get.back();
            ...
            Column(
              children: [
                ...
                SizedBox(width: 280, child: Text(textAlign: TextAlign.center, "Are you sure you want to Cancel this visit?", style: AppFonts.medium(17, AppColors.textBlack))),
                const SizedBox(height: 20),
