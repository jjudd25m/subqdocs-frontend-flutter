...
class PersonalSettingView extends GetView<PersonalSettingController> {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (controller.globalController.breadcrumbHistory.last !=
          controller.globalController.breadcrumbs[Routes.PERSONAL_SETTING]) {
    ...
    return BaseScreen(
      ...
      body: PopScope(
        ...
        // onPopInvoked: (didPop) {
        //   if (didPop) {
        //     print("on swipe called");
        //     controller.globalController.addRoute(Routes.PERSONAL_SETTING);
        //     // This will trigger for both back button and swipe gesture
        //     // controller.onSwipeBack();
        //   }
        // },
                                                                        ...
                                                                        GestureDetector(
                                                                          ...
                                                                          child: Obx(() {
                                                                            return ClipRRect(
                                                                              ...
                                                                              child:
                                                                                  controller.getUserDetailModel.value?.responseData?.profileImage !=
                                                                                          null
                                                                                      ? CachedNetworkImage(
                                                                                        imageUrl:
                                                                                            controller.getUserDetailModel.value?.responseData?.profileImage ??
                                                                                      ...
                                                                                      : controller.userProfileImage.value?.path !=
                                                                                          null
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Organization",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.organizationName ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Email ID",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.email ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Phone Number",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.contactNo ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Country",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.country ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "State",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.state ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "City",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.city ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Street Name",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.streetName ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Postal Code",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.postalCode ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Title",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.title ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          ...
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.medicalLicenseNumber ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "License Expiry Date",
                                                                          data:
                                                                              (controller.getUserDetailModel.value?.responseData?.licenseExpiryDate?.isNotEmpty ??
                                                                                      false)
                                                                                  ? DateFormat(
                                                                                    'MM/dd/yyyy',
                                                                                  ).format(
                                                                                    DateTime.parse(
                                                                                      controller.getUserDetailModel.value?.responseData?.licenseExpiryDate ??
                                                                                          "",
                                                                                    ),
                                                                                  )
                                                                                  : "-",
                                                                    ...
                                                                    children: [
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          ...
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.nationalProviderIdentifier !=
                                                                                      null
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Taxonomy Code",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.taxonomyCode ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Specialization",
                                                                          data:
                                                                              controller.getUserDetailModel.value?.responseData?.specialization ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                      ...
                                                                      GestureDetector(
                                                                        ...
                                                                        child: Obx(() {
                                                                          return ClipRRect(
                                                                            ...
                                                                            child:
                                                                                controller.getOrganizationDetailModel.value?.responseData?.profileImage !=
                                                                                        null
                                                                                    ? CachedNetworkImage(
                                                                                      imageUrl:
                                                                                          controller.getOrganizationDetailModel.value?.responseData?.profileImage ??
                                                                                    ...
                                                                                    : controller.organizationProfileImage.value?.path !=
                                                                                        null
                                                                                    ? RoundedImageFileWidget(
                                                                                      size:
                                                                                          60,
                                                                                      imagePath:
                                                                                          controller.organizationProfileImage.value,
                                                                                    )
                                                                                    : BaseImageView(
                                                                                      imageUrl:
                                                                                          "",
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Email ID",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.email ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Phone Number",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.contactNo ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Address 1",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.address1 ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Address 2",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.address2 ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "City",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.city ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                      ...
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "State",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.state ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Postal Code",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.postalCode ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                        child: CommonPatientData(
                                                                          label:
                                                                              "Country",
                                                                          data:
                                                                              controller.getOrganizationDetailModel.value?.responseData?.country ??
                                                                              "-",
                                                                        ),
                                                                      ),
                                                                      Expanded(
                                                                          ...
                                                                          onChanged: (
                                                                            ...
                                                                            if (value.isNotEmpty) {
                                                                              ...
                                                                              controller.filterGetUserOrganizationListModel.value?.responseData =
                                                                                  controller.getUserOrganizationListModel.value?.responseData?.where(
                                                                                    (
                                                                                      element,
                                                                                    ) {
                                                                                      String
                                                                              ...
                                                                              print(
                                                                                "filteredData ${controller.filterGetUserOrganizationListModel.value?.responseData?.length}",
                                                                              );
                                                                              print(
                                                                                "getUserOrganizationListModel ${controller.getUserOrganizationListModel.value?.responseData?.length}",
                                                                              );
                                                                            } else {
                                                                              print(
                                                                                "getUserOrganizationListModel ${controller.getUserOrganizationListModel.value?.responseData?.length}",
                                                            ...
                                                            child: SizedBox(
                                                              height:
                                                                  (controller
                                                                          ...
                                                                          false)
                                                                      ? 300
                                                                      : ((controller.filterGetUserOrganizationListModel.value?.responseData?.length ??
                                                                                  0) +
                                                                              1) *
                                                                          68,
                                                              child: Column(
  ...
  List<List<String>> _getTableRows(
    List<GetUserOrganizationListResponseData> patients,
  ) {
    ...
    for (var patient in patients) {
      rows.add([
        ...
        // Last Visit Date
        patient.lastLoginDate != null
            ? DateFormat(
              'MM/dd/yyyy',
            ).format(DateTime.parse(patient.lastLoginDate.toString()))
            : "-",
        // Previous Visits
        "Action",
      ]);
    ...
    return colIndex == 0
        ...
        ? PopupMenuButton<String>(
          ...
          itemBuilder:
              (context) => [
                for (var item
                    in controller.userRolesModel.value?.responseData ?? [])
                  PopupMenuItem(
                    padding: EdgeInsets.zero,
                    onTap: () async {
                      controller.updateRoleAndAdminControll(
