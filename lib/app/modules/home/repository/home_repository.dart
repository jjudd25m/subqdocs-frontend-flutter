...
class HomeRepository {
  // Future<PatientListModel> getFindContractorList({required Map<String, dynamic> pageSearchMap, required String parameter}) async {
  //   var response = await ApiProvider.instance.callGet("patient", queryParameters: pageSearchMap);
  //   if (kDebugMode) {
  //     print("getFindContractorList API response $response");
  //   }
