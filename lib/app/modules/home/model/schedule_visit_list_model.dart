...
class ScheduleVisitListData {
  ...
  ScheduleVisitListData({this.id, this.patientId, this.medicalAssistantName, this.visitId, this.profileImage, this.visitStatus, this.visitDate, this.visitTime, this.visitType, this.visitNotes, this.status, this.visitDetails, this.createdAt, this.updatedAt, this.deletedAt, this.firstName, this.lastName, this.gender, this.age, this.appointmentTime, this.doctorName, this.previousVisitCount});
