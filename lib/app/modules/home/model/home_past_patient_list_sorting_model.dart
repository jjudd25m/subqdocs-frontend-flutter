class HomePastPatientListSortingModel {
  ...
  // Constructor
  HomePastPatientListSortingModel({this.sortingPastPatient, this.pastVisitSelectedSorting, this.colIndex = -1, this.isAscending = true, this.selectedStatusIndex, this.selectedDoctorNames, this.selectedMedicationNames, this.selectedDoctorId, this.selectedMedicationId, this.selectedDateValue, this.startDate, this.endDate});
