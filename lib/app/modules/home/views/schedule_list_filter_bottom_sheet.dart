        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 20),
              Row(children: [Text("Visit Date", style: AppFonts.regular(14, AppColors.textBlack)), Spacer()]),
                        ...
                        PopupMenuItem(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(padding: const EdgeInsets.all(8.0), child: Text("Tomorrow", style: AppFonts.regular(14, AppColors.textBlack))),
                            ],
                          ),
                        ),
                        PopupMenuItem(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(width: double.infinity, height: 1, color: AppColors.appbarBorder),
                              Padding(padding: const EdgeInsets.all(8.0), child: Text("Next 7 Days", style: AppFonts.regular(14, AppColors.textBlack))),
                            ],
                          ),
                        ),
                        PopupMenuItem(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(width: double.infinity, height: 1, color: AppColors.appbarBorder),
                              Padding(padding: const EdgeInsets.all(8.0), child: Text("This Month", style: AppFonts.regular(14, AppColors.textBlack))),
                            ],
                          ),
                        ),
                      ],
              ...
              const SizedBox(height: 20),
              const SizedBox(height: 20),
              Row(children: [Text("Doctor", style: AppFonts.regular(14, AppColors.textBlack)), Spacer()]),
              ...
              const SizedBox(height: 20),
              Row(children: [Text("Medical Assistant", style: AppFonts.regular(14, AppColors.textBlack)), Spacer()]),
              SizedBox(height: 17.5),
              Obx(() {
                return ContainerDropdownView(
                  onRemove: (name, index) {
