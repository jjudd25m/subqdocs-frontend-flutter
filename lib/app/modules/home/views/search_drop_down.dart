      ...
      child: CupertinoTypeAheadField(
        builder:
            (context, controller, focusNode) => CupertinoTextField(
              ...
              suffix: Padding(padding: const EdgeInsets.symmetric(horizontal: 8), child: Icon(Icons.keyboard_arrow_down_rounded, color: AppColors.textDarkGrey)),
              focusNode: focusNode,
              autofocus: true,
        ...
        decorationBuilder:
            (context, child) => DecoratedBox(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: CupertinoDynamicColor.resolve(CupertinoColors.systemGrey4, context), width: 1),
              ),
              child: child,
            ),
        offset: Offset(0, 7),
        ...
        emptyBuilder: (context) {
          return Padding(padding: const EdgeInsets.all(15.0), child: Text("No Options ", textAlign: TextAlign.center));
        },
