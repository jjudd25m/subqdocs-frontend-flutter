...
class CustomCalender extends StatelessWidget {
  ...
  List<DateTime?> _rangeDatePickerValueWithDefaultValue = [DateTime(1999, 5, 6), DateTime(1999, 5, 21)];
  ...
  Widget build(BuildContext context) {
    _buildCalendarDialogButton() {
      ...
      final config = CalendarDatePicker2WithActionButtonsConfig(
        ...
        selectedDayHighlightColor: const Color.fromRGBO(116, 103, 183, 1),
        ...
        dayBuilder: ({required date, textStyle, decoration, isSelected, isDisabled, isToday}) {
          ...
          if (date.day % 3 == 0 && date.day % 9 != 0) {
            dayWidget = Container(decoration: decoration, child: Center(child: Stack(alignment: AlignmentDirectional.center, children: [Text(MaterialLocalizations.of(context).formatDecimal(date.day), style: textStyle)])));
          }
          return dayWidget;
        },
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ElevatedButton(
                onPressed: () async {
                  final values = await showCalendarDatePicker2Dialog(context: context, config: config, dialogSize: const Size(350, 370), borderRadius: BorderRadius.circular(15), value: _rangeDatePickerValueWithDefaultValue, dialogBackgroundColor: Colors.white);
                  //
                  // print("log11 ${values}");
                  if (values != null) {
                    displayTimePicker(context);

                    customPrint("log11 $values");
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Wrap(alignment: WrapAlignment.center, children: <Widget>[_buildCalendarDialogButton()]),
          const Wrap(alignment: WrapAlignment.center, children: <Widget>[]),
        ],
      ),
    );
  }
