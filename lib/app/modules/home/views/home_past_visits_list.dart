                          ...
                          ? Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(cellData, maxLines: 2, overflow: TextOverflow.visible, textAlign: TextAlign.center, style: AppFonts.medium(13, controller.getStatusColor(cellData))),
                              ),
                            ),
                          )
                          : colIndex == 6
                                ...
                                (context) => [
                                    ...
                                    PopupMenuItem(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(padding: const EdgeInsets.all(8.0), child: Text("view visit", style: AppFonts.regular(14, AppColors.textBlack))),
                                        ],
                                      ),
                                    ),
                                  ],
                                  ...
                                  PopupMenuItem(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(width: double.infinity, height: 1, color: AppColors.appbarBorder),
                                        Padding(padding: const EdgeInsets.all(8.0), child: Text("start now", style: AppFonts.regular(14, AppColors.textBlack))),
                                      ],
                                    ),
                                  ),
                                ],
