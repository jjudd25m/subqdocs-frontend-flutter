...
class CustomFilterListing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.ScreenBackGround, border: Border.all(color: AppColors.lightpurpule, width: 1), borderRadius: BorderRadius.all(Radius.circular(6))),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Text("Filters:", style: AppFonts.medium(14, AppColors.textBlack)),
          SizedBox(width: 5),
          Expanded(
            child: Wrap(
              children: List.generate(items.length + 1, (index) {
                if (index != items.length) {
                  ...
                  return Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(color: AppColors.ScreenBackGround, borderRadius: BorderRadius.circular(6), border: Border.all(color: AppColors.filterBorder, width: 1)),
                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [GestureDetector(onTap: oneClearAll, child: Text("Clear all", style: AppFonts.medium(12, AppColors.filterText)))],
                    ),
                  );
                }
              }),
