...
class SignUpSetOrganizationInfoView
    extends GetView<SignUpSetOrganizationInfoController> {
                      ...
                      children: [
                        ...
                        Obx(() {
                          return BaseDropdown<String>(
                            ...
                            items:
                                controller.userRolesModel.value?.responseData ??
                                [],
                    ...
                    child: CustomAnimatedButton(
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          customPrint(
                            "org name:- ${controller.organizationNameController.text}",
                          );
                          customPrint(
                            "provider:- ${controller.noOfProviderController.text}",
                          );
                          customPrint(
                            "org type:- ${controller.selectedRoleValue.value}",
                          );
