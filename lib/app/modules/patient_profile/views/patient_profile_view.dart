                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                CommonPatientData(label: "Patient ID", data: controller.patientDetailModel.value?.responseData?.patientId ?? "N/A"),
                                                SizedBox(height: 30),
                                                CommonPatientData(label: "Date of Birth", data: controller.dob.value ?? "N/A"),
                                              ],
                                            ),
                                            Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                CommonPatientData(label: "First Name", data: controller.patientDetailModel.value?.responseData?.firstName ?? "N/A"),
                                                SizedBox(height: 30),
                                                CommonPatientData(label: "Sex", data: controller.patientDetailModel.value?.responseData?.gender ?? "N/A"),
                                              ],
                                            ),
                                            Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Row(
                                                  children: [
                                                    CommonPatientData(label: "Middle Name", data: controller.patientDetailModel.value?.responseData?.middleName ?? "N/A"),

                                                    SizedBox(width: 120),
                                                    CommonPatientData(label: "Last Name", data: controller.patientDetailModel.value?.responseData?.lastName ?? "N/A"),
                                                  ],
                                                ),
                                                SizedBox(height: 30),
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text("No Visit Found", style: AppFonts.regular(16, AppColors.black)),
                                                          SizedBox(height: 4),
                                                          Text("Your scheduled visits will show here", style: AppFonts.regular(12, AppColors.black)),
                                                        ],
                                                      ),
                                                      Spacer(),
                                                      ContainerButton(
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          GestureDetector(
                                                                            ...
                                                                            child: Text(textAlign: TextAlign.center, "View", style: AppFonts.regular(15, AppColors.textPurple)),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                      SizedBox(height: 10),
