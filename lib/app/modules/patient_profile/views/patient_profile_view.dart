                                          ...
                                          Expanded(
                                            child: Row(
                                              children: [
                                                ...
                                                GestureDetector(
                                                  onTap: () async {
                                                    final _ = await Get.toNamed(Routes.EDIT_PATENT_DETAILS, arguments: {"patientData": controller.patientId, "visitId": controller.visitId, "fromSchedule": true});
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ExpansionTile(
                                      ...
                                      title: Row(children: [const SizedBox(width: 10), Text(textAlign: TextAlign.center, "Scheduled Visit", style: AppFonts.medium(16, AppColors.backgroundPurple))]),
                                      children: <Widget>[
                                  ...
                                  child: Padding(
                                    ...
                                    child: Theme(
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        backgroundColor: AppColors.backgroundPurple.withValues(alpha: 0.2),
                                        collapsedBackgroundColor: AppColors.backgroundPurple.withValues(alpha: 0.2),
                                        title: Row(children: [const SizedBox(width: 10), Text(textAlign: TextAlign.center, "Visit Recaps", style: AppFonts.medium(16, AppColors.backgroundPurple))]),
                                        children: <Widget>[
                                          Container(
                                            width: double.infinity,
                                            color: Colors.white,
