                  ...
                  children: [
                    ...
                    if (globalController.visitId.value.isNotEmpty ||
                      ...
                      DraggableFloatWidget(
                        ...
                        height:
                            !globalController.isExpandRecording.value
                                ? 88
                                : 520,
                                ...
                                if (globalController
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            ...
                                            print(
                                              " when the view is expanded  value of the y ${globalController.valueOfy}",
                                            );
                                            print(
                                              " when the view is expanded  value of the x ${globalController.valueOfx}",
                                            );
                                          },
                                  ...
                                  Container(
                                    ...
                                    child: SiriWaveform.ios7(
                                      controller:
                                          globalController.waveController,
                                        ...
                                        onTap: () async {
                                          File? audioFile =
                                              await globalController
                                                  ...
                                                  .stopRecording();
                                          globalController
                                              .stopLiveActivityAudio();
                                          customPrint(
                                            "audio file url is :- ${audioFile?.absolute}",
                                          );
                                          if (audioFile != null) {
                                            globalController.submitAudio(
                                              audioFile!,
                                            );
                                          }
                                        },
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          ...
                                          print(
                                            " when the view is non expanded  value of the y ${globalController.valueOfy}",
                                          );
                                          print(
                                            " when the view is non  expanded  value of the x ${globalController.valueOfx}",
                                          );

                                          globalController.valueOfy.value =
                                              globalController.adjustYPosition(
                                                globalController.valueOfy.value,
                                                context,
                                              );
                                        },
