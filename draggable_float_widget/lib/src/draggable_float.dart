...
class _CustomDraggableFloatState extends State<DraggableFloatWidget>
  ...
  _initBorderSize() {
    ...
    positionX =   widget.config.valueOfTheX!=0 ?widget.config.valueOfTheX : widget.config.initPositionXInLeft ? _left : _right;
    positionY =  widget.config.valueOfThey!=0  ? widget.config.valueOfThey:   widget.config.initPositionYInTop
